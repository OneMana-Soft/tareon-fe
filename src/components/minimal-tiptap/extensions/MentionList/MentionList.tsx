...
import ProfileService, {UserProfileDataInterface, UserProfileListInterface} from "../../../../services/ProfileService.ts";
...
export const mentionSuggestionOptions: MentionOptions["suggestion"] = {
  ...
  items: async ({ query }): Promise<UserProfileDataInterface[]> => {
      ...
      const usersList: UserProfileListInterface  = usersListRes.data
