...
export const MyUpcomingTaskList = ({updateStatus}:MyCompletedTaskListProps) => {
    const [pageSize, setPageSize] = useState<number>(5);
    const [animatingTaskId, setAnimatingTaskId] = useState<string | null>(null);
    const dispatch = useDispatch();
    const queryParam = GetTaskStatusQueryParamByStatus({getAll:false, pageSize:pageSize, getUpcoming: true});
    ...
    const hasMore = taskInfo.taskData?.pageCount && taskInfo.taskData?.pageCount > 1
