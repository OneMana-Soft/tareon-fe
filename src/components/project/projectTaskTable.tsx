...
export const ProjectTaskTable = ({projectId}: ProjectTaskTableProps) => {
    ...
    const { projectData, isLoading } = taskService.getProjectTaskList(projectId, urlParam);
    ...
    const data = projectData?.data.project_tasks || [];
    const pageCount = projectData?.pageCount || 1;
